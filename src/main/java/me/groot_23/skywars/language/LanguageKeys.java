...
public class LanguageKeys {
	...
	public static final String EVENT_REFILL = "game.event.refill";
	
	public static final String START_IN     = "game.start_in";
	public static final String STARTED      = "game.started";
	public static final String GET_READY    = "game.get_ready";
	public static final String FIGHT_BEGINS = "game.fight_begins";
